...
namespace IPA.CommonInterface.Helpers
{
    public static class EncoderDecoder
    {
        ...
        public static string Decode(byte[] encode)
        {
            ...
            Select(pos => binary.Substring(pos * 6, 6)).ToArray();
        ...
        public static byte[] Encode(string input)
        {
            ...
            Select(pos => Convert.ToByte(eightPadBitbinary.Substring(pos * 8, 8), 2)).ToArray();
    ...
    public class ReferenceTable
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(input) || ReferenceTableValues == null || ReferenceTableValues.Count == 0)
            { 
                return false;
            }
